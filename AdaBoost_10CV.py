...
from sklearn.ensemble import AdaBoostRegressor  # Zmiana importu na AdaBoostRegressor
    ...
    try:
        ...
        for file_name in file_list['File Path']:
            try:
                ...
                adaboost_regressor = AdaBoostRegressor()  # Utwórz obiekt AdaBoostRegressor
